...
class TranslationShaderClass : public AlignedAllocationPolicy<16>
{
private:
...
public:
	TranslationShaderClass() = default;
	TranslationShaderClass(const TranslationShaderClass& other);
	~TranslationShaderClass();
...
private:
	...
	ID3D11Buffer* m_translationBuffer = nullptr;
};